  ...
  return (
    <div className='relative'>
        ...
        <div className="absolute bottom-[55px] right-[48px] z-20 flex gap-[24px]">
            <div className="p-[5px]" >
                <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg"  className={`prev-btn ${isBeginning ? 'cursor-auto' : 'cursor-pointer'}`}>
            ...
            <div className="p-[5px]" >
                <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg"  className={`next-btn ${isEnd ? 'cursor-auto' : 'cursor-pointer'}`}>
        ...
        <div ref={paginationRef} className="custom-pagination !absolute z-20 !bottom-[78px] !left-1/2 !-translate-x-1/2 !flex !gap-[12px]"></div>
    </div>
  )
}
