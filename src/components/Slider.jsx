    ...
    <div className='relative'>
        ...
        >
            <SwiperSlide>
                ...
                bg="bg-[url('src/assets/slides/1.png')] bg-cover bg-no-repeat bg-center h-[420px]"
                />
            </SwiperSlide>
            <SwiperSlide>
                <Slide
                ...
                bg="bg-[url('src/assets/slides/2.png')] bg-cover bg-no-repeat bg-center h-[420px]"
                />
            </SwiperSlide>
            <SwiperSlide>
                <Slide
